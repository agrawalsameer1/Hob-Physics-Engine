...
void node::removeEntity() {
    ...
    /*if (parent != nullptr) {
        prevX = parent->mass*parent->COM[0];
        prevY = parent->mass*parent->COM[1];
        parent->mass -= myEntity->mass;
        parent->COM[0] = (prevX-myEntity->X)/parent->mass;
        parent->COM[1] = (prevY-myEntity->Y)/parent->mass;
    }*/
